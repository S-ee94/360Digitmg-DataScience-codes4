...
user_name = 'root'
database = 'lasso_ridge_db'
pw = 'Seemscrazy1994#'
engine = create_engine(f'mysql+pymysql://{user_name}:%s@localhost:3306/{database}' % quote(f'{pw}'))
# Load the offline data into Database 
startup = pd.read_csv(r"C:\Users\seema\OneDrive\Desktop\COURSE\360DigiTMG Course\Data Science_03052023_10AM(20032023)\Module 5.h-Lasso and Ridge Regression\Assignment\lasso_ridge\50_Startups.csv")
# # adver.info()
